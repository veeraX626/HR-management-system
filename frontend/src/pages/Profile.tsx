        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="lg:col-span-2">
          <div className="hrms-card">
            <div className="flex items-center justify-between mb-6">
              ...
              {!isEditing ? (
                <button onClick={() => setIsEditing(true)} className="hrms-button-secondary">
                  Edit Profile
                </button>
              ) : (
                <div className="flex gap-2">
                  ...
                  <button onClick={handleSave} className="hrms-button-primary flex items-center gap-2">
            ...
            <div className="flex items-center gap-6 mb-8 pb-8 border-b border-gray-200">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${isAdmin ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'}`}
                  >
