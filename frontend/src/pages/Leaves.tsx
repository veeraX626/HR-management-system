...
const Leaves: React.FC = () => {
  ...
  const fetchLeaves = async () => {
    setIsLoading(true)
    try {
      const records = user?.role === 'admin' ? await mockApi.getLeaves() : await mockApi.getLeaves(user?.employeeId)
      setLeaves(records)
    } catch (error) {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="hrms-card">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-gray-900 mt-2">{leaveStats.total - leaveStats.used}</h3>
            </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
        <div className="hrms-card">
          <div className="flex items-center justify-between mb-6">
            ...
            <button onClick={() => setShowApplyModal(true)} className="hrms-button-primary flex items-center gap-2">
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button type="submit" className="flex-1 hrms-button-primary">
                      Submit Application
                    </button>
                  </div>
                </form>
